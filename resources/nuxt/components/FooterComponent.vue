                    ...
                    <div class="footer-right">
                        <div class="social-section">
                            <ul>
                                ...
                                <li>
                                    <a href="https://twitter.com/unilad" target="_blank" class="twitter social-link">
                                ...
                                <li>
                                    <a href="https://www.youtube.com/user/uniladtv" target="_blank" class="youtube social-link">
                                        <svg style="width:30px;height:30px" viewBox="0 0 24 24">
...
<script>
    ...
    import StoryDialogComponent from './partials/StoryDialog'
