        ...
        <section class="terms-conditions section-space">
            <v-container grid-list-lg>
                <div>
                    ...
                    <p>I further undertake not to enter any future agreements over this content with any third parties, as required by the exclusivity of this agreement and will promptly forward any communications regarding my content to SNIFFR, as the new License Holder.</p>
                    <p>I hereby agree to indemnify, release and hold harmless SNIFFR, its successors, in any action arising from the use of the images, resulting from any breach by Licensor of any warranty, representation or any other provision of these Terms.</p>
                    <h2>Publicity/Confidentiality</h2>
                    <p>I shall not release, or cause the release, of any information concerning the Licensed Rights, SNIFFR or the terms of this License. I will inform SNIFFR if there are any changes to my personal details for the duration of this agreement. SNIFFR undertakes to maintain personal details confidentially and in accordance with all relevant data protection laws and the Privacy Policy available on our Website and incorporated herein.</p>
                    <h2>Terms &amp; Services</h2>
                    <p>I acknowledged, understands and agree to the additional terms and services displayed on the SNIFFR website which are incorporated herein by this reference and subject to change.</p>
                    <h2>Termination Clause</h2>
                    <p>The License shall only be terminable upon the mutual agreement of the parties with 5 months’ notice, I agree to indemnify SNIFFR for any losses from third party contracts arising due to termination. Termination will have no effect on any prior use or treatment of the images by SNIFFR, which may continue in perpetuity.</p>
