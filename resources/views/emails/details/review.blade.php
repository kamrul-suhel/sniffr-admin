    ...
    <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
      <tr>
        <td style="padding:18px 0px 18px 0px;line-height:22px;text-align:inherit;"
            ...
            valign="top"
            bgcolor="">
            <div><span style="font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal;"><b>Hey submission admin person!</b></span></div>
...
<div><a href="{{ URL::to('admin/videos/edit/' . $video->id) }}">{{ $video->title }}</a></div>
...
<div>The UNILAD Team.</span></div>
    ...
    <table class="module" role="module" data-type="social" align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
      <tbody>
        <tr>
        ...
        <a role="social-icon-link"  href="https://www.facebook.com/uniladmag/" target="_blank" alt="Facebook"
          data-nolink="false"
          title="Facebook "
          ...
          <img role="social-icon" alt="Facebook" title="Facebook "
            ...
            src="https://marketing-image-production.s3.amazonaws.com/social/white/facebook.png" />
                  ...
                  <td style="padding: 0px 5px;">
        <a role="social-icon-link"  href="https://twitter.com/UNILAD" target="_blank" alt="Twitter"
          data-nolink="false"
          title="Twitter "
          ...
          <img role="social-icon" alt="Twitter" title="Twitter "
            ...
            src="https://marketing-image-production.s3.amazonaws.com/social/white/twitter.png" />
                  ...
                  <td style="padding: 0px 5px;">
        <a role="social-icon-link"  href="https://www.instagram.com/unilad" target="_blank" alt="Instagram"
          data-nolink="false"
          title="Instagram "
