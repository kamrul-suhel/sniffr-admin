	...
	<div id="filemanager">
		...
		<div id="toolbar">
			<div class="btn-group offset-right">
                ...
                <button type="button" class="btn btn-primary" id="new_folder" onclick="jQuery('#new_folder_modal').modal('show');"><i class="fa fa-folder"></i> Add folder</button>
            </div>
            <button type="button" class="btn btn-default" id="refresh"><i class="fa fa-refresh"></i></button>
			<div class="btn-group offset-right">
                <button type="button" class="btn btn-default" id="move"><i class="fa fa-reply-all"></i> Move</button>
                <button type="button" class="btn btn-default" id="delete"><i class="fa fa-trash"></i> Delete</button>
            </div>
		</div>
		...
		<div class="breadcrumb-container">
			<ol class="breadcrumb filemanager">
				<li data-folder="/" data-index="0"><span class="arrow"></span><strong>Media Library</strong></li>
				<template v-for="folder in folders">
					<li data-folder="@{{folder}}" data-index="@{{ $index+1 }}"><span class="arrow"></span>@{{folder}}</li>
				</template>
			</ol>

			<div class="toggle"><span>Close</span><i class="icon fa fa-toggle-right"></i></div>
		</div>
			<div class="flex">
				...
				<div id="left">
					...
					<div id="no_files">
						 <h3><i class="fa fa-meh-o"></i> No files in this folder.</h3>
					</div>
