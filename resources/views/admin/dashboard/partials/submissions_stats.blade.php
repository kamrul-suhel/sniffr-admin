...
<div class="row">
    <div class="col-sm-3 col-xs-6">
        <div class="tile-stats tile-default">
            <a href="{{ url('/admin/licenses/videos') }}">
    ...
    <div class="col-sm-3 col-xs-6">
        <div class="tile-stats tile-aqua">
            <a href="{{ url('/admin/licenses/videos?state=new') }}">
    ...
    <div class="col-sm-3 col-xs-6">
        <div class="tile-stats tile-cyan">
            <a href="{{ url('admin/licenses/videos?state=pending') }}">
    ...
    <div class="col-sm-3 col-xs-6">
        <div class="tile-stats tile-green">
            <a href="{{ url('/admin/licenses/videos?state=licensed') }}">
