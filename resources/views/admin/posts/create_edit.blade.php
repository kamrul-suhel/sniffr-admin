...
<div id="admin-container">
	<ol class="breadcrumb">
		<li><a href="/admin/posts"><i class="fa fa-newspaper-o"></i>All Posts</a></li>
		<li class="active">@if(!empty($post->id)) <strong>{{ $post->title }}</strong> @else <strong>New Post</strong> @endif</li>
	</ol>
