				...
				<div id="nestable" class="nested-list dd with-margins">
					...
					@foreach($post_categories as $category)
						...
						<li class="dd-item" data-id="{{ $category->id }}">
							...
							<div class="actions"><a href="/admin/posts/categories/edit/{{ $category->id }}" class="edit">Edit</a> <a href="/admin/posts/categories/delete/{{ $category->id }}" class="delete">Delete</a></div>
