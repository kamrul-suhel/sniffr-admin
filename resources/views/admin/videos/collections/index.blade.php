...
@section('content')
	...
	<div class="admin-section-title">
		<div class="row">
			<div class="col-md-12">
				<h3><i class="fa fa-youtube-play"></i> Video Collections</h3><a href="javascript:;" onclick="jQuery('#add-new').modal('show');" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add New</a>
			</div>
		</div>
	</div>
