    ...
    <div id="admin-container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#pending_videos">Videos ({{ $pendingVideoCollections->count() }})</a></li>
                                    ...
                                    <form class="form_quote" action="{{ route('quotes.update', ['id' => $videoCollection->id]) }}" method="POST">
                                        ...
                                        <div class="panel panel-primary" data-collapsed="0">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="col-xs-3">
                                                    @if($videoCollection->collection->client->active)
                                                    ...
                                                    @else
                                                        <a class="btn btn-danger pull-right" href="{{ url('/admin/clients/edit', $videoCollection->collection->client->id) }}">Moderate</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#offered_videos">Videos ({{ $offeredVideoCollections->count() }})</a></li>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="col-xs-3">
                                                    <span class="form-group input-group">
                                                        ...
                                                        <input placeholder="£" value="£{{ $videoCollection->final_price }}" name="final_price" type="text" class="form-control" disabled>
                                                    </span>
