    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Create Contract for this Story</h4>
            </div>
                ...
                <form method="POST" action="{{ route('contract.store') }}" accept-charset="UTF-8">
                        ...
                        <div class="col-md-12">
                            <div class="form-group input-group">
                                ...
                                <select type="text" class="form-control" id="revenue_share" name="revenue_share"
                                    ...
                                    <option value="">--</option>
                                    @for($i=0; $i <= 100; $i = $i+5)
                                        <option value="{{ $i }}" {{ ((($story) && ($story->contract['revenue_share'] == $i)) || (old('revenue_share') == $i)) ? 'selected="selected"' : '' }}>
                                            Creator {{ $i }} %
                                        </option>
                                    @endfor
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group input-group">
                                ...
                                <input type="number" min="1" class="form-control" id="upfront_payment"
                                       ...
                                       value="{{ $story->contract->upfront_payment or old('upfront_payment') }}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="hidden" id="story_alpha_id" name="story_alpha_id"
                                   value="{{ $story->alpha_id }}"/>
                        </div>
                    </div>
                </div>
