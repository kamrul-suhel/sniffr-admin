<div class="panel panel-primary" data-collapsed="0">
    <div class="panel-heading">
        <div class="panel-title">Contract {!! ($asset && $asset->currentContract && $asset->currentContract->signed_at) ? 'Agreed' : ($asset && $asset->currentContract && $asset->currentContract->sent_at ? 'Sent '.($asset->currentContract->reminders ? ': <strong>'.$asset->currentContract->reminders.' Reminder'.($asset->currentContract->reminders > 1 ? 's' : '').'</strong>, Last Sent - ' : '').\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $asset->currentContract->sent_at)->diffForHumans() : '') !!}</div>
