...
export default {
  head: {"title":"Sniffr media","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[{"rel":"icon","type":"image\u002Fpng","href":"\u002Fassets\u002Fimages\u002Ffavicon.png"}],"script":[],"style":[]},
  render(h, props) {
