...
*/
    ...
    Route::get('admin/videos/{state}', array('before' => 'demo', 'uses' => 'AdminVideosController@index'));
    Route::get('admin/videos/status/{state}/{video}', array('before' => 'demo', 'uses' => 'AdminVideosController@status'));
