...
trait VideoHelper{
	...
	public static function getVideoHTML($video, $embed = false, $path = 'view') {
		...
		if($video->youtube_id){ // Youtube
			if($embed){
				$sHTML .= '<iframe src="https://www.youtube.com/embed/'.$video->youtube_id.'?playsinline=1&rel=0&autoplay=1" class="youtube-iframe" type="text/html" frameborder="0"  allowfullscreen></iframe>';
			}else{
