...
class ContractBump2 extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->view('emails.contracts.accept_link_bump_2')->with('asset', $asset)
            ->text('emails.contracts.accept_link_bump_2_text')
