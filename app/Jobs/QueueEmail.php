...
use App\Mail\ContractBump1;
use App\Mail\ContractBump2;
            ...
            if ($asset->contact_id == 0 || $asset->contact_id == NULL) {
                ...
                switch ($this->email_type) {
                    ...
                    case 'details_thanks':
                        ...
                        break;
					case 'contract_bump_1':
						Mail::to($asset->contact->email)->send(new ContractBump1($asset->id, $asset->currentContract, $this->type));
						break;
					case 'contract_bump_2':
						Mail::to($asset->contact->email)->send(new ContractBump2($asset->id, $asset->currentContract, $this->type));
						break;
