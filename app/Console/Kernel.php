...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
		...
		'\App\Console\Commands\AutomateContractReminders',
    ...
    protected function schedule(Schedule $schedule)
    {
		...
		$automateContractReminders = 'storage/logs/scheduler.log';
		...
		$schedule->command('AutomateContractReminders:sendReminders')
			->hourly()
			->between('8:00', '21:00')
			->appendOutputTo($automateContractReminders);
