...
1. The Licensor agrees that UNILAD be granted the <strong>Non-exclusive</strong>, unlimited right to use, and to exhibit, distribute, and hereafter devise, in any manner upon all UNILAD platforms, through its affiliates or otherwise, throughout the world, in perpetuity, for any purpose whatsoever as UNILAD in its sole discretion may determine (the “Licensed Rights”). I, the Licensor, agree that UNILAD has permission to distribute this asset in accordance with this Licence as they may in their sole discretion see fit.  UNILAD may in it\'s sole discretion remove any material distributed on its platform for any reason whatsoever.
...
2. The Licensor hereby agrees that UNILAD (including partners, affiliates) may use any asset on the Licensor\'s channel for exclusive submission to it\'s platforms.  The Licensor grants UNILAD an exclusive licence for all material contained on the Licensor\'s channel.  UNILAD may remove any material which is posted on its platforms for any reason whatsoever.  T  This contract may only be terminated by mutual agreement or in the event of serious material breach by either party.

3. UNILAD reserves the right to refuse, in it\'s sole discretion, to use any asset or material available on the Licensor\'s channel.

4. The Licensor agrees that UNILAD be granted the Non-exclusive, unlimited right to use, and to exhibit, distribute, and hereafter devise, in any manner upon all UNILAD platforms, through its affiliates or otherwise, throughout the world, in perpetuity, for any purpose whatsoever as UNILAD in its sole discretion may determine (the “Licensed Rights”). I, the Licensor, agree that UNILAD has permission to distribute this asset in accordance with this Licence as they may in their sole discretion see fit.  UNILAD may in it\'s sole discretion remove any material distributed on its platform for any reason whatsoever.

5. The Licensor certifies that they act with full lawful authority to grant this License, and warrant that there has not been any previous grant of any other license to third parties in relation to these images and it is expressly understood that UNILAD has not assumed any obligations under any other contracts entered into by the Licensor.

6. The Licensor undertakes not to enter any future agreements over this content with any third parties, as required by the exclusivity of this agreement and will without undue delay forward any communications regarding this content to UNILAD, as the new License Holder.

7. All profits from revenues generated therefrom will be split UNILAD: :unilad_share Licensor:  :creator_share.

8. The Licensor hereby agrees that UNILAD will determine as the sole arbitrator sums defined as ‘revenues’ and it shall be determined by them exclusively following deductions for, but not limited to, reasonable expenses, third party liabilities, distribution costs and all expenses incurred in promoting and protecting the intellectual property of the content.

9. The Licensor hereby agrees to indemnify, release and hold harmless UNILAD, its successors, in any action arising from the use of the images, resulting from any breach by Licensor of any warranty, representation or any other provision of these Terms.

10. It is hereby agreed that if any clause in this contract or part thereof is deemed void or voidable in law, the remaining clauses in this agreement are severable and remain enforceable.


<strong>Publicity/Confidentiality</strong>

11. The Licensor shall not release, or cause the release, of any information concerning the Licensed Rights, UNILAD or the terms of this License unless required to do so by law.


<strong>Terms & Conditions</strong>

12. Licensor has acknowledged, understands and agrees to the terms and conditions displayed on the UNILAD website which may change from time to time and which are incorporated herein by this reference.


<strong>Termination</strong>

13. This License shall only be terminable upon the mutual agreement of the parties with 5 months notice, after which termination will have no effect on any prior use or treatment of the images by UNILAD, which may continue in perpetuity.
...
',
	...
	5 =>
		[
			'id' => 5,
			'rights' => 'exce',
			'name' => 'Editorial License and Release',
			'text' => '
Date: :contract_date
Licensor: :licensor_name
Email: :licensor_email
...
Images: All images/screenshots in regards to the above story
Video: All video in regards to the above story
Twitter: All tweets in regards to above
Instagram: All posts in regards to above story
Reddit: All posts in regard to above story
Facebook: All posts in regard to above story
Quotes and all information in regards to above story


Asset Ref: :video_ref
Contract Ref: :contract_ref_number

This license (“License”) is made and entered into as of :contract_date herein with reference to the undersigned’s (“Licensor”) (also referred to as ‘they’) grant to UNILAD, its successors, etc (collectively, “UNILAD”) of the Licensed Rights with respect to all/any part of the audio-visual, editorial and abstract work(s), hereafter referred to as ‘this content’ or as further described below, including without limitation all intellectual property, images, identifiable characters and/or individuals, music, sounds, or other trademarks and logos, and all other rights depicted/contained therein (the “Images”).  The Work refers to the content contained in both the Accepted Manuscript (AM) and the Version of Record (VOR). “Supplementary Material” consists of material that is associated with the article but linked to or accessed separately (available electronically only), including but not limited to data sets and any additional files.

:upfront_payment

1. The Licensor agrees that UNILAD be granted the exclusive, unlimited right to use, and to exhibit, distribute, and hereafter devise, in any manner upon all UNILAD platforms throughout the world, in perpetuity, for any purpose whatsoever as UNILAD in its sole discretion may determine (the “Licensed Rights”). Licensor furthermore does hereby irrevocably appoint UNILAD as its attorney-in-fact in relation to the rights over this content.

2. The Licensor certifies that they act with full lawful authority to grant this License, and warrant that there has not been any previous grant of any other license to third parties in relation to these works and it is expressly understood that UNILAD has not assumed any obligations under any other contracts entered into by myself.

3. The Licensor certifies that they are the sole owner of all intellectual property rights for the content or have the express permission of the rights holder to submit this content to UNILAD for use at its sole discretion under this grant of Licensed Rights.

4. The Licensor undertakes not to enter any future agreements over this content with any third parties, as required by the exclusivity of this agreement and will without undue delay forward any communications regarding this content to UNILAD, as the new License Holder.

5. All net profits from revenues generated therefrom will split UNILAD: :unilad_share Licensor:  :creator_share.

6.The Licensor hereby agrees that UNILAD will determine at its sole discretion and as the sole arbitrator ‘net revenue’ and will include but is not limited to, reasonable expenses, third party liabilities, distribution costs and all expenses incurred in protecting the intellectual property of the content.

7. The Licensor undertakes they have full lawful authority to grant this license, and warrants that there has not been any previous grant of any other license to third parties in relation to these images and it is expressly understood that UNILAD has not assumed any obligations under any other contracts or otherwise entered into by the Licensor

8. The Licensor hereby agrees to indemnify, release and hold harmless UNILAD, its successors, in any action arising from the use of the images, resulting from any breach by Licensor of any warranty, representation or any other provision of these Terms.


<strong>Publicity/Confidentiality</strong>

9. The Licensor shall not release, or cause the release, of any information concerning the Licensed Rights, UNILAD or the terms of this License. 
