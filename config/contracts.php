...
The Licensor agrees that UNILAD be granted the exclusive, unlimited right to use, and to exhibit, distribute, and hereafter devise, in any manner upon all UNILAD platforms, through its affiliates or otherwise, throughout the world, in perpetuity, for any purpose whatsoever as UNILAD in its sole discretion may determine (the “Licensed Rights”). Licensor furthermore does hereby irrevocably appoint UNILAD as its attorney-in-fact in relation to the rights over these images.

The Licensor certifies that they are the sole owner of all intellectual property rights for the content or have the express permission of the rights holder to submit this content to UNILAD for use at its sole discretion under this grant of Licensed Rights.

The Licensor certifies that they act with full lawful authority to grant this License, and warrant that there has not been any previous grant of any other license to third parties in relation to these images and it is expressly understood that UNILAD has not assumed any obligations under any other contracts entered into by the Licensor.

The Licensor undertakes not to enter any future agreements over this content with any third parties, as required by the exclusivity of this agreement and will without undue delay forward any communications regarding this content to UNILAD, as the new License Holder.

All profits from revenues generated therefrom will be split UNILAD: :unilad_share Licensor: :creator_share 
...
The Licensor hereby agrees to indemnify, release and hold harmless UNILAD, its successors, in any action arising from the use of the images, resulting from any breach by Licensor of any warranty, representation or any other provision of these Terms.

It is hereby agreed that if any clause in this contract or part thereof is deemed void or voidable in law, the remaining clauses in this agreement are severable and remain enforceable.

Publicity/Confidentiality. 

The Licensor shall not release, or cause the release, of any information concerning the Licensed Rights, UNILAD or the terms of this License unless required to do so by law.

Terms & Conditions

Licensor has acknowledged, understands and agrees to the terms and conditions displayed on the UNILAD website which may change from time to time and which are incorporated herein by this reference.  
Termination
This License shall only be terminable upon the mutual agreement of the parties with 5 months notice, after which termination will have no effect on any prior use or treatment of the images by UNILAD, which may continue in perpetuity.
...
',
    ...
    2 =>
        [
            'id' => 2,
            'name' => 'Non-Exclusive with distribution rights License and Release Contract',
            'text' => '
Date: :contract_date
Licensor: :licensor_name
Email: :licensor_email
...
',
    ...
    3 =>
        [
            'id' => 3,
            'name' => 'Non-Exclusive Channel License and Release Contract',
            'text' => '
Date: :contract_date
Licensor: :licensor_name
Email: :licensor_email
...
This license (“License”) is made and entered into as of :contract_date herein with reference to the undersigned’s (“Licensor”) irrevocable grant to UNILAD, its successors, etc (collectively, “UNILAD”) of the Licensed Rights (defined below) with respect to all/any part of the audio-visual work(s), hereafter referred to as ‘content’ or as further described below, including without limitation all intellectual property, images, identifiable characters and/or individuals, music, sounds, or other trademarks and logos, and all other rights depicted/contained therein (the “content”).
Licensor undertakes that:
The Licensor hereby agrees that UNILAD (including partners, affiliates) may use any video on the Licensor\'s channel for non-exclusive submission to it\'s platforms.  The Licensor grants UNILAD an non-exclusive licence for all material contained on the Licensor\'s channel.  

UNILAD may remove any material which is posted on its platforms for any reason whatsoever.  The Licensor agrees that s/he will only receive payment for the period content is live on their platforms.  This contract may only be terminated by mutual agreement or in the event of serious material breach by either party.

UNILAD reserves the right to refuse, in it\'s sole discretion, to use any video or material available on the Licensor\'s channel.

I certify that I act with full lawful authority to grant this License, and warrant that there has not been any previous grant of any other exclusive license to third parties in relation to these images and it is expressly understood that UNILAD has not assumed any obligations under any other contracts entered into by myself. 

I further undertake not to enter any future exclusive agreements over this content with any third parties, as required by the exclusivity of this agreement and will promptly forward any communications regarding my content to UNILAD, as the new License Holder.
...
',
    ...
    4 =>
        [
            'id' => 4,
            'name' => 'Exclusive Channel License and Release Contract',
            'text' => '
Date: :contract_date
Licensor: :licensor_name
Email: :licensor_email
...
This license (“License”) is made and entered into as of :contract_date herein with reference to the undersigned’s (“Licensor”) irrevocable grant to UNILAD, its successors, etc (collectively, “UNILAD”) of the Licensed Rights (defined below) with respect to all/any part of the audio-visual work(s), hereafter referred to as ‘content’ or as further described below, including without limitation all intellectual property, images, identifiable characters and/or individuals, music, sounds, or other trademarks and logos, and all other rights depicted/contained therein (the “content”).
Licensor undertakes that:
The Licensor hereby agrees that UNILAD (including partners, affiliates) may use any video on the Licensor\'s channel for exclusive submission to it\'s platforms.  The Licensor grants UNILAD an exclusive licence for all material contained on the Licensor\'s channel.  
