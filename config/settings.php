...
return [
    ...
    'theme' => [],
    'terms' => [
        'terms_ex' => '<p><strong>Ownership</strong></p>
                ...
                <p>I agree to submit and licence this video and its content to UNILAD and their associated companies for their use at their sole discretion, in exchange you will be given the opportunity to receive a one of fee of £100 if the video is used on the UNILAD facebook page as a stand alone post, not part of a compilation.</p>
...
<p><strong>Termination Clause</strong></p>
	       ...
	       <p>I certify that I am the sole owner of all intellectual property rights for this video or have the express permission of the rights holder to submit this video to UNILAD for exclusive publishing on UNILAD.</p>
	       <p>I agree to submit and licence this video and its content to UNILAD and their associated companies for their use at their sole discretion, in exchange you will be given the opportunity to receive a one of fee of £100.</p>',
        'contact_is_owner' => 'I confirm that I filmed this video and/or I am the rightful owner to this video.',
        'allow_publish' => 'I confirm that I am happy for this video to be published and viewed by potentially millions of people. (Especially in cases where there are minors/children in the video).',
        'is_exclusive' => 'I confirm that I am granting UNILAD an exclusive license to this video and understand that this means I cannot and will not enter into a discussion with any other company regarding this content. I understand that UNILAD are the new license holders and I will inform them of any contact I receive from another company regarding the use of this video.',
        'terms_non_ex' => '<p><strong>Ownership</strong></p>
                <p>I certify that I am the sole owner of all intellectual property rights for this video or have the express permission of the rights holder to submit this video to UNILAD for exclusive publishing on UNILAD.</p>
