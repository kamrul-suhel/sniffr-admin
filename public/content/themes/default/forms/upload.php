                ...
                <div class="panel panel-primary" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="first_name" name="first_name" value="<?php echo 'Moo';//old('first_name'); ?>" >
                        </div>

                        <div class="form-group">
                            <label for="last_name">Last Name <span>*</span></label>
                            <input type="text" class="form-control" id="last_name" name="last_name" value="<?php echo 'Moo';//old('last_name'); ?>" >
                        </div>

                        <div class="form-group">
                            <label for="tel">Email <span>*</span></label>
                            <input type="email" class="form-control" id="email" name="email" value="<?php echo 'moo@example.com';//old('email'); ?>" >
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="panel panel-primary" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title" value="<?php echo 'Moo';//old('title'); ?>">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group unshaded" id="make-shaded-url">
                                    ...
                                    <input class="form-control files" type="text" id="url" name="url" value="<?php echo 'https://www.youtube.com/watch?v=FtO62R_UKkc';//old('url'); ?>" placeholder="">
                                </div>
                            </div>
