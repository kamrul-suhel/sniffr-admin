...
?>
	...
	<link rel="stylesheet" href="<?= URL::asset('content/plugins/series/assets/css/style.css') ?>" />
	<script src="<?= URL::asset('content/plugins/series/assets/js/vue.min.js') ?>"></script>
	...
	<div id="video_title">
		<div class="container">
			<span class="label" style="background:#DB1D1B">You're watching:</span> <h1><?= $title ?></h1>
	...
	<div class="container">
		...
		<div id="left_content">
			...
			<div class="video-details-container"><?= $details ?></div>
			<br />
			<div class="clear"></div>
	...
	<script type="text/javascript">
		...
		function getEpisodes(){
			var url = '/api/v1/series/' + <?= $series->id ?> + '/episodes/' + '<?= $episode->id ?>';
